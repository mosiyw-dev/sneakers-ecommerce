...
export function AnimatedBadge({
  ...
  return (
    <motion.span
      ...
      className={cn(
        "relative inline-flex shrink-0 items-center overflow-hidden whitespace-nowrap rounded-full border font-bold tabular-nums",
    ...
    >
      {pulse && !reduce ? (
        <motion.span
          ...
          animate={{ scale: [0.94, 1.08, 0.94], opacity: [0.08, 0.2, 0.08] }}
